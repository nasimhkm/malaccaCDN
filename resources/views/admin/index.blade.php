    ...
    <body>
        ...
        <main>
            ...
            <div class="p-4 sm:ml-64 mt-16 text-white">
                @if (session('success'))
                <div
                    class="p-4 mb-4 text-sm text-green-400 bg-gray-800 rounded-lg"
                    role="alert"
                >
                    {{ session('success') }}
                </div>
                            ...
                            <tbody>
                                ...
                                >
                                    <td class="w-4 p-4">
                                        <div class="flex items-center">
                                            <input
                                                id="checkbox-table-search-{{ $article->id }}"
                                                type="checkbox"
                                                class="w-4 h-4 text-blue-600 bg-gray-700 border-gray-600 rounded focus:ring-blue-600 ring-offset-gray-800 focus:ring-2"
                                            />
                                            <label
                                                for="checkbox-table-search-{{ $article->id }}"
                                                class="sr-only"
                                                >checkbox</label
                                            >
                                        </div>
                                    ...
                                    >
                                        <div>
                                            <p>{{ $article->title }}</p>
                                            <div
                                                class="flex items-center space-x-2 text-xs text-gray-400 hidden group-hover:block mt-1"
                                            >
                                                <a
