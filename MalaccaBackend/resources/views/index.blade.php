  ...
  <body>
    <header>
      ...
      >
        ...
        >
          ...
          <a href="#hero">
            <img
              src="/asset/logo/logoCompany.svg"
    ...
    <main>
      ...
      >
        ...
        >
          <div class="pt-16 md:pt-0">
            <img
              ...
              class="w-24 md:w-36 mb-4 md:mb-0 md:mr-10 mx-auto"
              alt="Malacca Logo"
            />
          </div>
          <div>
        ...
        <div>
          <button
            type="button"
            class="py-2.5 px-6 text-xl text-sm font-medium text-white bg-transparent rounded-full border md:border-[3px] border-white hover:bg-white/10 transition-colors"
          >
      ...
      >
        ...
        >
          ...
          <p class="text-gray-200 leading-relaxed mb-4">
            Kami adalah entitas yang berakar dari semangat untuk menghadirkan
            pengalaman kopi yang autentik di tengah dinamika Jakarta Timur. Kami
            lahir dari semangat kolaboratif untuk membangun ekosistem F&B yang
            lebih inovatif dan berkelanjutan.
          </p>
          <p class="text-gray-200 leading-relaxed">
            Dengan menggabungkan pendekatan kreatif, riset mendalam, dan
            nilai-nilai komunitas, kami berkomitmen menjadi mitra pertumbuhan
            yang adaptif dan relevan di tengah dinamika industri makanan dan
            minuman Indonesia.
          </p>
        </div>
        <div class="relative w-full md:w-1/2 h-96 md:h-screen">
          <img
            src="/asset/img/tentang.png"
      ...
      >
        ...
        >
          ...
          <div class="border border-dashed border-white p-6 rounded-3xl flex-1">
            <img
              src="/asset/icon/coffeehouse.png"
              alt="Coffeehouse icon"
              class="h-12 mb-4"
            />
            <h2 class="text-2xl font-bold mb-2">malacca coffeehouse</h2>
            <p class="text-sm text-gray-300 leading-relaxed">
              <span class="font-bold">Malacca Coffeehouse</span> membangun nilai
              pembeda melalui sajian berkualitas berbahan eksklusif yang dikemas
              secara sederhana. Hal ini menciptakan pengalaman yang autentik
              untuk konsumen. Kami menghadirkan ruang dengan nuansa homie dan
              pelayanan yang menjunjung kesetaraan, menjadikan setiap kunjungan
          ...
          <div class="border border-dashed border-white p-6 rounded-3xl flex-1">
            <img
              src="/asset/icon/advisory.png"
              alt="Advisory icon"
              class="h-12 mb-4"
            />
            <h2 class="text-2xl font-bold mb-2">malacca advisory</h2>
            <p class="text-sm text-gray-300 leading-relaxed">
              <span class="font-bold">Malacca Advisory</span> merupakan unit
              konsultasi yang berfokus pada pemberdayaan wirausahawan di sektor
              makanan dan minuman (F&B). Unit ini menyediakan layanan yang
              mencakup riset dan pengembangan (R&D), perumusan strategi bisnis,
              serta optimalisasi operasional, guna mendorong pertumbuhan usaha
      ...
      <section id="showcase" class="min-h-screen flex flex-col bg-black py-16">
        <div class="max-w-screen-xl mx-auto px-4">
          <div class="text-center text-white w-full max-w-4xl mx-auto mb-12">
            ...
            <h1 class="font-bold text-3xl md:text-4xl mt-2">
              beberapa tulisan yang kami sediakan
            </h1>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="bg-white rounded-3xl shadow-lg flex flex-col">
              <img
                ...
                src="/asset/img/manualbrew.JPG"
                alt="Manual Brew"
              />
              <div class="p-5 flex flex-col flex-grow">
                <h6 class="text-[#6c0c0d] font-bold">coffee</h6>
                ...
                >
                  Sensasi seduhan kopi dengan teknik dan metode manual yang
                  disajikan dengan kualitas selera industri. Ini menjadi
                  sentuhan momen terbaik yang menghasikan ragam rasa.
                  Menambahkan teks panjang untuk memastikan clamping berfungsi.
                </p>
                <button
                  type="button"
            ...
            <div class="bg-white rounded-3xl shadow-lg flex flex-col">
              <img
                class="rounded-t-lg w-full h-[250px] object-cover"
                src="/asset/img/tehsusu.JPG"
                alt="Teh Susu"
              />
              <div class="p-5 flex flex-col flex-grow">
                <h6 class="text-[#6c0c0d] font-bold">non coffee</h6>
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-black">
                  teh susu
                </h5>
                <p
                  class="product-description line-clamp-3 mb-3 font-normal text-justify text-gray-700 flex-grow"
                >
                  Racikan ragam komponen buatan rumah dengan standar industry
                  komponen pilihan, menjadi cita rasa khas identic untuk teman
                  baik aktivitas kamu.
                </p>
                <button
                  type="button"
            ...
            <div class="bg-white rounded-3xl shadow-lg flex flex-col">
              <img
                class="rounded-t-lg w-full h-[250px] object-cover"
                src="/asset/img/kombucha.JPG"
                alt="Kombucha"
              />
              <div class="p-5 flex flex-col flex-grow">
                <h6 class="text-[#6c0c0d] font-bold">fermentation</h6>
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-black">
                  kombucha
                </h5>
                <p
                  class="product-description line-clamp-3 mb-3 font-normal text-justify text-gray-700 flex-grow"
                >
                  Bahan baku rumah, yang dikelola dengan nilai dan rasa.
                  menghasilkan pengalaman sensasi yang komplek untuk jadi awal
                  dari setiap perjumpaan dan pembicaraaan.
                </p>
                <button
                  type="button"
                  class="read-more-btn text-blue-600 hover:underline self-start"
      ...
      <section
        ...
        style="background-image: url('/asset/img/kalibrasi.png')"
      >
        ...
        <div class="relative text-center z-30 p-4">
          ...
          <p class="font-thin text-lg md:text-xl">
            a brand activation by <span class="font-bold">malacca</span>
          </p>
        </div>
    ...
    <footer class="bg-black">
      <section
        ...
        style="background-image: url('/asset/img/kunjungi.png')"
      >
        ...
        >
          ...
          >
            <img
              ...
              class="w-24 mb-4"
            />
            <p class="text-sm text-gray-300 leading-relaxed max-w-xs mb-6">
              Malacca adalah ruang kopi yang tumbuh dari kolaborasi, riset, dan
              nilai komunitas, untuk menghadirkan ekosistem F&B yang kreatif dan
              berkelanjutan.
            </p>
          ...
          >
            ...
            >
              <p class="text-sm text-gray-300 leading-relaxed max-w-xs">
                Jalan Jl. Kemuning 7 No.32, RT.1/RW.8, Malaka Sari, Kec. Duren
          ...
          >
            ...
            <div class="text-sm text-gray-300 space-y-2 mb-6">
              <a href="tel:+6287888814075" class="block hover:underline"
                >+62 878 8881 4075</a
              >
              <a
        ...
        <div class="relative text-center py-8">
          <p class="text-xs text-gray-400">
            &copy; Malacca Entreprise | All Rights Reserved
          </p>
        </div>
      </section>
    </footer>
    ...
    <script src="/scripts/main-page.js" defer></script>
  </body>
</html>
